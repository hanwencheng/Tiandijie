...
from primitives.RequirementCheck.RequirementsCheck import \
    RequirementCheck as Check
...
class Formations:
    ...
    wannianlunhui = FormationTemp('wannianlunhui', 'tieshouxiahouyi',
                                  [{'element': Elements.THUNDER}, {'element': Elements.WATER}], [
                                      ModifierEffect(partial(Check.PositionChecks.life_not_full_in_range, 3),
    ...
    sanshentongzhi = FormationTemp('sanshentongzhi', 'zhenyin', [{'has_formation': True}, {'has_formation': True}],
                                   [ModifierEffect(partial(Check.PositionChecks.has_partner_in_range, 2),
    ...
    lunbadixie = FormationTemp('lunbadixie', 'gulunde', [{'gender': Gender.MALE}, {'gender': Gender.MALE}], [
        ModifierEffect(partial(Check.LifeChecks.life_not_full), {ma.physical_damage_percentage: 10, ma.magic_damage_percentage: 10})])
    ...
    fokoushexin = FormationTemp('fokoushexin', 'qing', [{'element': Elements.THUNDER}, {'element': Elements.LIGHT}],
                                [ModifierEffect(partial(Check.BuffChecks.target_harm_buff_count),
    ...
    xiafengxiren = FormationTemp('xiafengxiren', 'xige', [{'element': Elements.FIRE}, {'element': Elements.THUNDER}], [
        ModifierEffect(partial(Check.always_true), {ma.single_target_skill_damage_percentage: 10})])
    ...
    yuanlongliangyi = FormationTemp('yuanlongliangyi', 'zhaoyou',
                                    ...
                                    [ModifierEffect(partial(Check.PositionChecks.has_element_hero_in_range, [Elements.FIRE, Elements.WATER], 3),
                                                    {ma.physical_damage_percentage: 10, ma.magic_damage_percentage: 10})])
    ...
    xiongxingzhenhuang = FormationTemp('xiongxingzhenhuang', 'yinqianyang',
                                       [{'profession': Professions.SORCERER}, {'profession': Professions.GUARD}], [
                                           ModifierEffect(partial(Check.LifeChecks.self_life_is_higher, 50),
                                                          {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}
                                                          ),
                                           ModifierEffect(partial(Check.LifeChecks.target_life_is_higher, 50),
    ...
    jianxinlinchan = FormationTemp('jianxinlinchan', 'bingchuanyujian',
                                   [{'profession': Professions.RIDER}, {'profession': Professions.PRIEST}], [
                                       ModifierEffect(partial(Check.is_attacker), {ma.physical_penetration_percentage: 10, ma.magic_penetration_percentage: 10}),
                                       ModifierEffect(partial(Check.PositionChecks.attack_enemy_in_range_count_bigger_than_with_base_2, 3, 2),
    ...
    jianzhuoyanran = FormationTemp('jianzhuoyanran', 'anyi',
                                   [{'profession': Professions.ARCHER}, {'profession': Professions.PRIEST}], [
                                       ModifierEffect(partial(Check.LifeChecks.target_life_is_below, 100),
    ...
    jiandanxingchi = FormationTemp('jiandanxingchi', 'yanchixia',
                                   [{'profession': Professions.SORCERER}, {'profession': Professions.PRIEST}], [
                                       ModifierEffect(partial(Check.PositionChecks.in_range_count_with_limit, 3, 4),
    ...
    morandongyue = FormationTemp('morandongyue', 'baifugui', [{'element': Elements.WATER}, {'element': Elements.DARK}],
                                 [
                                     ModifierEffect(partial(Check.PositionChecks.has_harm_buff_partner_in_range, 2),
                                                    {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}),
                                     ModifierEffect(partial(Check.PositionChecks.has_harm_buff_enemy_in_range, 2),
                                                    {ma.physical_damage_reduction_percentage: 8, ma.magic_damage_reduction_percentage: 8})])
    ...
    tianmingxuanuye = FormationTemp('tianmingxuanuye', 'longye',
                                    [{'profession': Professions.SWORDSMAN}, {'profession': Professions.PRIEST}], [
                                        ModifierEffect(partial(Check.battle_with_no_element_advantage),
    ...
    tianshimingguang = FormationTemp('tianshimingguang', 'shuangshuang',
                                     [{'element': Elements.DARK}, {'element': Elements.THUNDER}], [
                                         ModifierEffect(partial(Check.PositionChecks.has_benefit_buff_partner_in_range, 2),
                                                        {ma.physical_damage_percentage: 10, ma.magic_damage_percentage: 10}
                                                        )])
    ...
    tianenmiaoxue = FormationTemp('tianenmiaoxue', 'yuxiaoxue',
                                  [{'profession': Professions.GUARD}, {'profession': Professions.SWORDSMAN}], [
                                      ModifierEffect(partial(Check.BuffChecks.self_harm_buff_count_smaller_than, 3),
                                                     {ma.physical_damage_percentage: 10, ma.magic_damage_percentage: 10})])
    ...
    tianmowanxiang = FormationTemp('tianmowanxiang', 'jianxie',
                                   [{'element': Elements.DARK}, {'element': Elements.WATER}], [
                                       ModifierEffect(partial(Check.PositionChecks.enemy_in_range_count_bigger_than, 2, 3),
    ...
    youshiyutian = FormationTemp('youshiyutian', 'shuangyaobingli',
                                 [{'profession': Professions.SWORDSMAN}, {'profession': Professions.PRIEST}], [
                                     ModifierEffect(partial(Check.in_battle_with_non_flyable),
    ...
    youminyehua = FormationTemp('youminyehua', 'liyou', [{'element': Elements.DARK}, {'element': Elements.DARK}], [
        ModifierEffect(partial(Check.BuffChecks.target_harm_buff_count_bigger_than, 3),
    ...
    youhuantianqi = FormationTemp('youhuantianqi', 'huoyong', [{'element': Elements.FIRE}, {'element': Elements.WATER}],
                                  [ModifierEffect(partial(Check.LifeChecks.self_life_is_higher_and_no_harm_buff, 50),
                                                  {ma.physical_damage_percentage: 15, ma.magic_damage_percentage: 15})])

    # 弦月封霜阵: 上阵封寒月和至少2位「冰」属性英灵时，激活战阵。所有我方上阵角色物攻，物防，法攻，法防提升15%，自身满血时，物穿，法穿提高10%。
    xianyuefengshuang = FormationTemp('xianyuefengshuang', 'fenghanyue',
                                      [{'element': Elements.WATER}, {'element': Elements.WATER}], [
                                          ModifierEffect(partial(Check.LifeChecks.life_is_full), {ma.physical_penetration_percentage: 10,
    ...
    anyuedouling = FormationTemp('anyuedouling', 'yuebo',
                                 [{'profession': Professions.GUARD}, {'profession': Professions.WARRIOR}], [
                                     ModifierEffect(partial(Check.BuffChecks.target_has_harm_buff, 'attribute_reduction'),
                                                    {ma.battle_damage_percentage: 8,
    ...
    zhaohuaximeng = FormationTemp('zhaohuaximeng', 'jiuyin', [{'element': Elements.LIGHT}, {'element': Elements.DARK}],
                                  [ModifierEffect(
                                      partial(Check.PositionChecks.element_hero_in_range, [Elements.LIGHT, Elements.DARK], 3),
    ...
    liuajuesha = FormationTemp('liuajuesha', 'baaini',
                               [{'profession': Professions.SORCERER}, {'profession': Professions.PRIEST}], [
                                   ModifierEffect(partial(Check.always_true),
                                                  {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8, ma.critical_percentage: 8}),
                                   ModifierEffect(partial(Check.PositionChecks.in_range_partner_count_with_limit, 2, 2),
                                                  {ma.physical_damage_percentage: -4, ma.magic_damage_percentage: -4, ma.critical_percentage: -4})])

    # 海潮升歌阵: 上阵露葵和「铁卫」，「祝由」英灵至少各一位时，激活战阵。所有我方上阵角色物攻，物防，法攻，法防提高15%。自身满血时，伤害提高8%，气血未满时，免伤提高8%。
    haichaoshengge = FormationTemp('haichaoshengge', 'lukui',
                                   [{'profession': Professions.GUARD}, {'profession': Professions.PRIEST}], [
                                       ModifierEffect(partial(Check.LifeChecks.life_is_full),
                                                      {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}),
                                       ModifierEffect(partial(Check.LifeChecks.life_not_full),
                                                      {ma.physical_damage_reduction_percentage: 8, ma.magic_damage_reduction_percentage: 8}
                                                      )])

    # 灼光雷鸣阵: 上阵阿秋和「炎」，「光」属相英灵至少各一位时，激活战阵。所有我方上阵角色物攻，物防，法攻，法防提高15%，使用伤害绝学时，对处于自身直线位置的目标，暴击率和伤害提高8%。
    zhuoguangleiming = FormationTemp('zhuoguangleiming', 'aqiu',
                                     [{'element': Elements.FIRE}, {'element': Elements.LIGHT}], [
                                         ModifierEffect(partial(Check.PositionChecks.in_the_same_line),
                                                        {ma.single_target_skill_damage_percentage: 8, ma.range_skill_damage_percentage: 8, ma.critical_percentage: 8})])
    ...
    qianlingshehun = FormationTemp('qianlingshehun', 'nike', [{'profession': Professions.WARRIOR}, {'profession': Professions.SWORDSMAN}],
                                   [ModifierEffect(partial(Check.is_attacker), {ma.battle_damage_percentage: 7}),
                                    ModifierEffect(partial(Check.enemies_in_skill_range, 4),
                                                   {ma.range_skill_damage_percentage: 2, ma.single_target_skill_damage_percentage: 2})])
    ...
    hulingshenfen = FormationTemp('hulingshenfen', 'taixuanlinghu',
                                  ...
                                  [ModifierEffect(partial(Check.LifeChecks.target_life_is_below, 90),
                                                  {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}),
                                   ModifierEffect(partial(Check.LifeChecks.self_life_is_below, 90),
                                                  {ma.physical_damage_reduction_percentage: 8, ma.magic_damage_reduction_percentage: 8})])

    # 琼华飞仙阵: 上阵紫枫和「羽士」，「祝由」英灵至少各一位时，激活战阵。所有我方上阵角色物攻，物防，法攻，法防提升15%，携带移动力提高的状态时，使用绝学伤害提高10%。
    qionghuafeixian = FormationTemp('qionghuafeixian', 'zifeng', [{'profession': Professions.ARCHER}, {'profession': Professions.PRIEST}],
    ...
    xuanguangtianying = FormationTemp('xuanguangtianying', 'xingzhanxianzhe', [{'element': Elements.LIGHT}, {'element': Elements.LIGHT}],
                                      [ModifierEffect(partial(Check.PositionChecks.element_hero_in_range, [Elements.LIGHT], 2),
                                                      {ma.critical_damage_reduction_percentage: 8, ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8})])
    ...
    shenwuxishu = FormationTemp('shenwuxishu', 'fuyayu', [{'gender': Gender.MALE}, {'gender': Gender.FEMALE}],
                                [ModifierEffect(partial(Check.PositionChecks.has_male_in_range, 2), {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}),
                                 ModifierEffect(partial(Check.PositionChecks.has_female_in_range, 2), {ma.physical_damage_reduction_percentage: 8, ma.magic_damage_reduction_percentage: 8})])
    ...
    zuimenghongchen = FormationTemp('zuimenghongchen', 'lixiaoyao', [{'profession': Professions.SORCERER}, {'profession': Professions.RIDER}],
                                    [ModifierEffect(partial(Check.BuffChecks.target_benefit_buff_count),
                                                    {ma.physical_damage_percentage: 5, ma.magic_damage_percentage: 5})])
    ...
    fuxingzhuosheng = FormationTemp('fuxingzhuosheng', 'yunjia', [{'element': Elements.DARK}, {'element': Elements.THUNDER}],
                                    [ModifierEffect(partial(Check.always_true), {ma.physical_damage_percentage: 15, ma.magic_damage_percentage: 15}),
                                     ModifierEffect(partial(Check.PositionChecks.in_range_enemy_count_with_limit, 3, 3),
                                                    {ma.physical_damage_percentage: -5, ma.magic_damage_percentage: -5})])
    ...
    fenghuajianying = FormationTemp('fenghuajian', 'yinwuxie', [{'gender': Gender.FEMALE}, {'gender': Gender.FEMALE}],
                                    [ModifierEffect(partial(Check.PositionChecks.has_female_in_range, 2),
                                                    {ma.physical_damage_percentage: 10, ma.magic_damage_percentage: 10})])
    ...
    guiminglianyu = FormationTemp('guiminglianyu', 'xianyuchao', [{'profession': Professions.ARCHER}, {'profession': Professions.SORCERER}],
                                  [ModifierEffect(partial(Check.LifeChecks.self_life_is_higher, 70),
                                                  {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8})])
