...
class Skills(Enum):
    ...
    lvxiwanbian = SkillTemp('lvxiwanbian', 1, Elements.ETHEREAL, SkillType.Move, 3, Distance(DistanceType.NORMAL, 4), Range(RangeType.POINT, 0, 1, 1), 0, [], [EventListener(2, RS.always_true, )])
