...
class Talents:
    ...
    mianshenglibai = Talent('mianshenglibai', 'lv', [ModifierEffect(RS.always_true, {ma.battle_damage_percentage: 15})], [EventListener(EventTypes.action_end, 1, RS.always_true, partial(Effects.add_enemies_harm_buff_and, additional_buff_name='youjin', enemy_number=2, buff_number=1, range=7, duration=2))])
