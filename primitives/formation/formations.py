...
class Formations:
    ...
    yuanlongliangyi = FormationTemp('yuanlongliangyi', 'zhaoyou',
                                    ...
                                    [ModifierEffect(partial(Check.PositionChecks.has_element_hero_in_range,
                                                            [Elements.FIRE, Elements.WATER], 3),
                                                    {ma.physical_damage_percentage: 10,
                                                     ma.magic_damage_percentage: 10})])
    ...
    jianxinlinchan = FormationTemp('jianxinlinchan', 'bingchuanyujian',
                                   [{'profession': Professions.RIDER}, {'profession': Professions.PRIEST}], [
                                       ModifierEffect(partial(Check.is_attacker),
                                                      {ma.physical_penetration_percentage: 10,
                                                       ma.magic_penetration_percentage: 10}),
                                       ModifierEffect(partial(
                                           Check.PositionChecks.attack_enemy_in_range_count_bigger_than_with_base_2, 3,
                                           2),
    ...
    zhaohuaximeng = FormationTemp('zhaohuaximeng', 'jiuyin', [{'element': Elements.LIGHT}, {'element': Elements.DARK}],
                                  [ModifierEffect(
                                      partial(Check.PositionChecks.element_hero_in_range,
                                              [Elements.LIGHT, Elements.DARK], 3),
    ...
    liuajuesha = FormationTemp('liuajuesha', 'baaini',
                               [{'profession': Professions.SORCERER}, {'profession': Professions.PRIEST}], [
                                   ...
                                   ModifierEffect(partial(Check.PositionChecks.in_range_partner_count_with_limit, 2, 2),
                                                  {ma.physical_damage_percentage: -4, ma.magic_damage_percentage: -4,
    ...
    qianlingshehun = FormationTemp('qianlingshehun', 'nike',
    ...
    qionghuafeixian = FormationTemp('qionghuafeixian', 'zifeng',
                                    [{'profession': Professions.ARCHER}, {'profession': Professions.PRIEST}],
    ...
    xuanguangtianying = FormationTemp('xuanguangtianying', 'xingzhanxianzhe',
                                      [{'element': Elements.LIGHT}, {'element': Elements.LIGHT}],
                                      [ModifierEffect(
                                          partial(Check.PositionChecks.element_hero_in_range, [Elements.LIGHT], 2),
                                          {ma.critical_damage_reduction_percentage: 8, ma.physical_damage_percentage: 8,
                                           ma.magic_damage_percentage: 8})])

    # 璇玑引雷阵: 上阵慕容璇玑和至少2位「雷」属性英灵时，激活战阵。所有我方上阵角色物攻，物防，法攻，法防提升15%，主动攻击暴击率提升15%。
    xuanjiyinlei = FormationTemp('xuanjiyinlei', 'murongxuanji',
    ...
    zhufahuasheng = FormationTemp('zhufahuasheng', 'jiuselu',
                                  [{'profession': Professions.SORCERER}, {'profession': Professions.PRIEST}],
                                  [ModifierEffect(partial(Check.LifeChecks.life_is_full),
                                                  {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}),
                                   ModifierEffect(partial(Check.BuffChecks.self_has_no_harm_buff),
    ...
    shenwuxishu = FormationTemp('shenwuxishu', 'fuyayu', [{'gender': Gender.MALE}, {'gender': Gender.FEMALE}],
                                [ModifierEffect(partial(Check.PositionChecks.has_male_in_range, 2),
                                                {ma.physical_damage_percentage: 8, ma.magic_damage_percentage: 8}),
    ...
    shenguantianche = FormationTemp('shenguantianche', 'yunyigongzhu',
                                    [{'element': Elements.THUNDER}, {'element': Elements.LIGHT}],
                                    [ModifierEffect(partial(Check.self_all_active_skills_in_cooldown),
                                                    {ma.physical_damage_percentage: 10,
                                                     ma.magic_damage_percentage: 10})])
    ...
    zidianqingshuang = FormationTemp('zidianqingshuang', 'ziyun',
                                     [{'element': Elements.THUNDER}, {'element': Elements.THUNDER}],
    ...
    zuimenghongchen = FormationTemp('zuimenghongchen', 'lixiaoyao',
    ...
    wenxianduyu = FormationTemp('wenxianduyu', 'xuezhi',
                                [{'profession': Professions.SORCERER}, {'profession': Professions.PRIEST}],
                                [ModifierEffect(partial(Check.target_all_active_skills_in_cooldown),
                                                {ma.physical_damage_percentage: 10, ma.magic_damage_percentage: 10})])

    # 附星擢升阵: 上阵允迦和「暗」，「雷」属相英灵至少各一位时，激活战阵。所有我方上阵角色物攻，物防，法攻，法防提高15%，伤害提升15%，3格范围内每有1个敌方，造成伤害降低5%（最多15%）。
    fuxingzhuosheng = FormationTemp('fuxingzhuosheng', 'yunjia',
                                    [{'element': Elements.DARK}, {'element': Elements.THUNDER}],
                                    [ModifierEffect(partial(Check.always_true), {ma.physical_damage_percentage: 15,
    ...
    guiminglianyu = FormationTemp('guiminglianyu', 'xianyuchao',
    ...
    guangyanzhutian = FormationTemp('guangyanzhutian', 'murongzheng',
                                    [{'element': Elements.FIRE}, {'element': Elements.FIRE}],
    ...
    toulangxunlie = FormationTemp('toulanxunlie', 'canglang',
                                  [{'profession': Professions.SORCERER}, {'profession': Professions.PRIEST}],
                                  [ModifierEffect(
    ...
    huanbingningshuang = FormationTemp('huanbingningshuang', 'longyao',
                                       [{'element': Elements.WATER}, {'element': Elements.WATER}],
