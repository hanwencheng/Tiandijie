...
class BuffTemps(Enum):
    ...
    lagong = BuffTemp(
        ...
        [
            EventListener(
                EventTypes.double_attack_end,
                1,
                RS.always_true,
                partial(Effects.remove_actor_certain_buff, "lagong"),
            )
        ],
    )
    ...
    silie = BuffTemp(
        ...
        [
            EventListener(
                ...
                RS.always_true,
                partial(
                    Effects.receive_fixed_damage_by_caster_physical_attack, multiplier=0.7, is_magic=False
                ),
            ),
            EventListener(
                EventTypes.under_damage_end,
                ...
                partial(RS.attacked_by_caster),
                partial(
                    Effects.increase_actor_certain_buff_stack, "silie"),
            )
        ],
    )
    ...
    liuxue = BuffTemp(
        ...
        [
            EventListener(
                ...
                RS.always_true,
                partial(
                    Effects.receive_fixed_damage_by_caster_physical_attack, multiplier=0.3
                ),
            ),
        ],
    )
    ...
    zhuochen = BuffTemp(
        ...
        [
            ...
            EventListener(
                ...
                1,
                RS.always_true,
                partial(Effects.add_buffs, buff_temp=["dundi"], duration=2),
            ),
        ],
    )
    ...
    niepan = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                RS.always_true,
                partial(Effects.heal_self_by_magic_attack, multiplier=0.5),
            ),
        ],
    )
