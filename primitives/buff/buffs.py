...
class BuffTemps(Enum):
    ...
    sanmei_zhenhuo = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                RS.always_true,
                partial(Effects.receive_fixed_magic_damage_by_caster_magic_attack, multiplier=0.5),
            )
        ],
    )
    ...
    xianzui = BuffTemp(
        ...
        [
            ...
            ModifierEffect(partial(RS.self_all_active_skills_in_cooldown), {ma.move_range: -1}),
        ],
    )
    ...
    jianjue = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                RS.always_true,
                partial(Effects.add_self_buffs, buff_temp=["jianjue"]),
            ),
            EventListener(
                EventTypes.skill_single_damage_end,
                1,
                partial(RS.BuffChecks.buff_stack_reach, 3, buff_id="jianjue"),
                partial(
    ...
    chuti = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                partial(RS.is_attacker),
                partial(Effects.add_self_buffs, "chuti"),
            )
        ],
    )
    ...
    silie = BuffTemp(
        ...
        [
            ...
            EventListener(
                ...
                1,
                partial(RS.attacked_by_caster),
                partial(Effects.add_self_buffs, "silie"),
            ),
        ],
    )
        ...
        [
            ...
            [
                ...
                EventListener(
                    ...
                    1,
                    RS.always_true,
                    partial(Effects.reverse_target_benefit_buffs_in_range, 2, 2),
                ),
            ],
        ],
    )
    ...
    xumengzhijing = BuffTemp(
        ...
        [
            ModifierEffect(
                RS.always_true,
                {
                    ma.is_extra_action_disabled: 2,
                    ma.is_extra_move_disabled: 2,
                },
            ),
        ],
        [
    ...
    kuli = BuffTemp(
        ...
        [
            ...
            [
                ...
                ModifierEffect(
                    partial(RS.BuffChecks.buff_stack_reach, 4, "kuli"),
        ...
        [
            ...
            [
                EventListener(
                    ...
                    1,
                    partial(RS.BuffChecks.buff_stack_reach, 6, "kuli"),
    ...
    juexingzhili = BuffTemp(
        ...
        [
            EventListener(
                EventTypes.buff_start,
                1,
                partial(RS.BuffChecks.buff_stack_reach, 6, "juexingzhili"),
    ...
    juexin = BuffTemp(
        ...
        [
            EventListener(
                EventTypes.buff_start,
                1,
                partial(RS.BuffChecks.buff_stack_reach, 5, "juexin"),
    ...
    xinnian = BuffTemp(
        ...
        [
            EventListener(
                EventTypes.buff_start,
                1,
                partial(RS.BuffChecks.buff_stack_reach, 2, "xinnian"),
    ...
    duijue = BuffTemp(
        ...
        [
            ModifierEffect(
                ...
                {
                    ma.critical_percentage: -20,
                    ma.critical_damage_reduction_percentage: -20,
    ...
    ruizou = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                partial(RS.is_attacker),
                partial(Effects.add_actor_and_caster_energy, 1),
            ),
            EventListener(
                EventTypes.critical_damage_end,
                1,
    ...
    longyan = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                RS.is_attacker,
                partial(Effects.add_caster_energy, 1),
            )
        ],
    )
    ...
    feiyu = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                partial(RS.is_attacker),
                partial(Effects.add_extra_move, 2),
            ),
        ],
    )
    ...
    youkai = BuffTemp(
        ...
        [
            EventListener(
                ...
                1,
                RS.always_true,
                partial(Effects.remove_actor_certain_buff, "youkai"),
            ),
            EventListener(
    ...
    #             1,
    #             partial(RS.PositionChecks.in_range, 2),
    #             partial(Effects.increase_damage_and_critical_rate, 0.1),
    #         ),
    #     ],
    # )
