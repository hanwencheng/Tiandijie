class ModifierAttributes:
    ...
    single_target_skill_damage_reduction_percentage = 'single_target_skill_damage_reduction_percentage'
    ...
    normal_attack_damage_reduction_percentage = 'normal_attack_damage_reduction_percentage'
